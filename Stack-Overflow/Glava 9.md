...
+ Перед суффиксом `F` или `L` (например, неопустимы запись 1.23_F или 9999999_L).
...
Шестандцатеричное число - это значение по основанию 16. В нем 16 цифр, 0-9 и буквы A-F (регистр не имеет значения). A-F соответствует числам 10-15.
