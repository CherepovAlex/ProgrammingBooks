...
Тип данных `short` - это 16-разрядное целое число со знаком. Его минимальное значение -2<sup>15</sup> (-32,768), а максимальное 2<sup>15</sup>-1 (32,767)
...
По умолчанию значение `short` равно 0
