...
Этот класс также даёт возможность проводить над данными такие операции, как чтение значения времени, а также сложение и вычитание часов, минут, секунд и наносекунда, т.е.
