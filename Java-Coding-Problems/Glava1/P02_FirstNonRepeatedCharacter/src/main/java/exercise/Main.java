...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("\n\nASCII or 16 bits Unicode characters (less than 65_535 (0xFFFF)) examples:\n");

        System.out.println("Loop and break solution");
        long startTimeV1 = System.nanoTime();
        long firstcharV1 = Strings.firstNonRepeatedCharacterV1(TEXT);
        ...
        String firstcharV5 = Strings.firstNonRepeatedCharacterV5(TEXT_CP);
