...
public class Strings {
    ...
    public static long countOccurrencesOfACertainCharacterVCP1(String str, String ch) {

        if (str == null || ch == null || str.isEmpty() || str.isEmpty()) {
            // or throw IllegalArgumentException
            return -1;
        }
        ...
        // if ch.length() return 2 then this is Unicode surrogate pair
