...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Java 8, functional-syle solution:");
        ...
        long countV4 = Strings.countOccurrencesOfACertainCharacterVCP1(TEXT_CP, CHAR_TO_COUNT_CP);
        ...
        long countV5 = Strings.countOccurrencesOfACertainCharacterVCP1(TEXT_CP, CHAR_TO_COUNT_CPS);
        ...
        long countV8 = Strings.countOccurrencesOfACertainCharacterVCP3(TEXT, CHAR_TO_COUNT_CP);
        ...
        long countV9 = Strings.countOccurrencesOfACertainCharacterVCP3(TEXT, CHAR_TO_COUNT_CPS);
