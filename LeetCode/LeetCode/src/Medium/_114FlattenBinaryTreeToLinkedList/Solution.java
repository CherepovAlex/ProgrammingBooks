package Medium._114FlattenBinaryTreeToLinkedList;
...
// Есть как минимум два разных letters символа.
// Верните наименьший символ в letters, который лексикографически больше target. Если такого символа нет, верните
// первый символ в letters.
// Example 1:
...
public class Solution {
    ...
    public static void main(String[] args) {
        char[] letters = {'c', 'f', 'j'};
        char target = 'a';
        System.out.println(new Solution().nextGreatestLetter(letters, target)); // 'c'
    }
}
