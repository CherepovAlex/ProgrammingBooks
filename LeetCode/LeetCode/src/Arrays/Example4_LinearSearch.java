...
public class Example4_LinearSearch {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(linearSearch(array1, array1.length, 5));
        ...
        System.out.println("Does the array contain the element 4? - " + Example4_LinearSearch.linearSearch(array, length, 4));
        System.out.println("Does the array contain the element 30? - " + Example4_LinearSearch.linearSearch(array, length, 30));
