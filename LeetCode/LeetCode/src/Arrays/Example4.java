...
public class Example4 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Does the array contain the element 4? - " + Example4.linearSearch(array, length, 4));
        System.out.println("Does the array contain the element 30? - " + Example4.linearSearch(array, length, 30));
