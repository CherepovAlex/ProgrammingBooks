...
public class Example6 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.toString(new Example6().copyWithRemovedDuplicates(nums1)));
        System.out.println(Arrays.toString(new Example6().copyWithRemovedDuplicates(nums2)));
    }
