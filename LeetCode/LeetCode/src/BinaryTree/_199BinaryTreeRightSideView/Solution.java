package BinaryTree._199BinaryTreeRightSideView;
...
public class Solution {
    ...
    // Альтернативное решение - через DFS (обход в глубину).
    // Преимущества вашего BFS решения:
    //Время выполнения: O(n) - каждый узел посещается один раз
    //Память: O(n) - в худшем случае (полное двоичное дерево)
    //Легко читается и понимается
    //Гарантированно находит правый вид за один проход
